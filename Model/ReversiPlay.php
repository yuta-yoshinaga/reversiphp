...
class ReversiPlay
{
	...
	{
		if($this->_viewMsgDlg != NULL) $this->_viewMsgDlg($title, $msg);
	}
	...
	{
		if($this->_drawSingle != NULL) $this->_drawSingle($y, $x, $sts, $bk, $text);
	}
	...
	{
		if($this->_curColMsg != NULL) $this->_curColMsg($text);
	}
	...
	{
		if($this->_curStsMsg != NULL) $this->_curStsMsg($text);
	}
}
